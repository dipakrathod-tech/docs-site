...
- `/usr/local/`: Location for software you manually compile and install locally using `make`, keeping it separate from system-managed packages.
...
<Callout type="success">
  **Next Steps:** Now that you understand the filesystem *layout*, the next
  step is learning how to interact with Linux systems. The following section
  covers user interfaces and access methods, including GUI components, CLI
  fundamentals, and the critical distinctions between shells, consoles, and
  terminals.
</Callout>
